...
from user.views import PasswordChangeView, RegisterUpdateView, RegisterView, email_verification, UserListView, \
    SuccessRegisterView, SuccessConfirmView, PasswordResetCustomView, PasswordResetCustomConfirmView, \
...
urlpatterns = [
    ...
    path('reset/done/', PasswordResetCompleteView.as_view(template_name='user/success_confirm.html'), name='password_reset_complete'),
]
